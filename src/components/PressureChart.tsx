...
function PressureChart({ pressure }: PressureChartProps) {
  function pressureToPercentage(pressure: number) {
    if (pressure < 900) return 0;
    if (pressure > 1100) return 100;
    return ((pressure - 900) / 200) * 100;
  }
